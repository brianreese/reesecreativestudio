 ...
 * @endcode
 */
$settings['hash_salt'] = 'DQKwRRY6lr4HZHIseCKtzAsxYGA0xZOyex8a1RZetxZH2hnLcDnb7Xr';
...
if ($is_local_env) {
  ...
  if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_reesecreativestudio_dd.inc')) {
    require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_reesecreativestudio_dd.inc';
  }
